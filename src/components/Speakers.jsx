...
const keynotesData = [
  ...
  { img: "", initials: "GS", name: "Gurudev Sri Sri Ravi Shankar", company: "El Arte de Vivir", role: "Líder Humanitario", bio: "Líder humanitario y maestro espiritual, fundador de la organización internacional El Arte de Vivir.", gradient: "linear-gradient(135deg,#E91E8C,#F0922A)", talkIcon: "🧘‍♂️", talkName: "Sabiduría Eterna" }
];
