...
const keynotesData = [
  ...
  { img: "Speakers/Dr_Arumugam_Murukiah.jpg", initials: "AM", name: "Dr. Arumugam Murukiah", company: "Broadline Technologies", role: "Estratega Tecnológico", bio: "Líder en transformación digital con más de 4 décadas de experiencia. Innovador en salud pública y cadenas de suministro en la India.", gradient: "linear-gradient(135deg,#F0922A,#ef4444)", talkIcon: "⚙️", talkName: "IA Humanizada" },
...
const speakersData = [
  ...
  { img: "Speakers/Sofialeticia_Morales_Garza.jpg", initials: "SM", name: "Dra. Sofialeticia Morales", company: "Legado Nuevo León", role: "Coordinadora Educativa", bio: "Ex Secretaria de Educación de NL. Impulsora de modelos educativos innovadores y asesora para Naciones Unidas.", gradient: "linear-gradient(135deg,#a3335f,#8B5CF6)", trackClass: "track-c", trackName: "Educación", talkIcon: "🎓", talkName: "IA en Educación Superior" },
