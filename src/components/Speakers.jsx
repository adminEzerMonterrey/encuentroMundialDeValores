...
const speakersData = [
  ...
  { img: "/speakers/jorge-ramos.jpeg", initials: "JR", name: "Jorge Ramos", company: "Periodista", role: "Escritor y Periodista", bio: "Influyente periodista hispanohablante y escritor. Cubrió eventos históricos y es autor de 15 libros sobre política e inmigración.", gradient: "linear-gradient(135deg,#E91E8C,#8B5CF6)", talkIcon: "🎙️", talkName: "Compromiso con la verdad" },
