...
const keynotesData = [
  ...
  { img: "Speakers/Dr._Arumugam_Mrukiah.png", initials: "AM", name: "Dr. Arumugam Murukiah", company: "Broadline Technologies", role: "Estratega Tecnológico", bio: "Líder en transformación digital con más de 4 décadas de experiencia. Innovador en salud pública y cadenas de suministro en la India.", gradient: "linear-gradient(135deg,#F0922A,#ef4444)", talkIcon: "⚙️", talkName: "IA Humanizada" },
  { img: "Speakers/Caroline_Sanchez_Crozier.jpg", initials: "CC", name: "Caroline Sanchez Crozier", company: "CSC Consulting Group", role: "CEO & Fundadora", bio: "Líder tecnológico y presidenta del Comité de Tecnología e IA de LULAC. Inmigrante mexicana y pionera en equidad digital.", gradient: "linear-gradient(135deg,#E91E8C,#9333ea)", talkIcon: "🤝", talkName: "Tecnología y Educación" },
...
const speakersData = [
  ...
  { img: "Speakers/Dra._Sofialeticia_Morales_Garza.png", initials: "SM", name: "Dra. Sofialeticia Morales", company: "Legado Nuevo León", role: "Coordinadora Educativa", bio: "Ex Secretaria de Educación de NL. Impulsora de modelos educativos innovadores y asesora para Naciones Unidas.", gradient: "linear-gradient(135deg,#a3335f,#8B5CF6)", trackClass: "track-c", trackName: "Educación", talkIcon: "🎓", talkName: "IA en Educación Superior" },
  ...
  { img: "Speakers/Eugenio_Garza_y_Garza_UDEM.png", initials: "EG", name: "Eugenio Garza y Garza", company: "UDEM", role: "Rector", bio: "Rector entrante de la UDEM, combina experiencia empresarial y compromiso educativo ante los desafíos de la Inteligencia Artificial.", gradient: "linear-gradient(135deg,#00d4fe,#8B5CF6)", trackClass: "track-c", trackName: "Educación Superior", talkIcon: "🎓", talkName: "IA en la Educación" },
