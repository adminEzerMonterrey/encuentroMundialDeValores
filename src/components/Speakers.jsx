...
const speakersData = [
  ...
  },
  {
    ...
    bio: "Presidente de Grupo ORSAN, fiduciario de La Fundación Rotaria (2023–2027) y Arquitecto por la UNAM.",
    longBio: "Carlos Sandoval es Presidente de Grupo ORSAN. Forma parte del Consejo de Fiduciarios de La Fundación Rotaria para el periodo 2023–2027. Arquitecto por la UNAM.",
    bullets: [
