...
const keynotesData = [
  ...
  { img: "Speakers/Dr._Arumugam_Mrukiah.png", initials: "AM", name: "Dr. Arumugam Murukiah", company: "Broadline Technologies", role: "Emprendedor y Líder Digital", bio: "Líder en transformación digital con más de 4 décadas de experiencia. Innovador en salud pública y cadenas de suministro en la India.", gradient: "linear-gradient(135deg,#F0922A,#ef4444)", talkIcon: "⚙️", talkName: "IA Humanizada" },
...
const speakersData = [
  ...
  { img: "", initials: "MZ", name: "Monica Zambrano Vignau", company: "HUMIND", role: "Experta en Bienestar Emocional", bio: "Participa en el panel de IA y Salud: 'El Ser Humano como Guía, la IA como Soporte'.", gradient: "linear-gradient(135deg,#a3335f,#8B5CF6)", trackClass: "track-a", trackName: "Salud", talkIcon: "❤️", talkName: "El Ser Humano como Guía" },
  { img: "", initials: "SL", name: "Sofía Lozano Snively", company: "Ingenium", role: "Experta en Bienestar", bio: "Participa en el panel de IA y Salud: 'El Ser Humano como Guía, la IA como Soporte'.", gradient: "linear-gradient(135deg,#2E86C1,#8B5CF6)", trackClass: "track-a", trackName: "Salud", talkIcon: "❤️", talkName: "El Ser Humano como Guía" },
  ...
  { img: "", initials: "NE", name: "Nayo Escobar", company: "Empresario", role: "Músico y creador de contenido", bio: "Empresario y músico originario de Monterrey con más de 2 millones de suscriptores en YouTube realizando entrevistas inspiracionales.", gradient: "linear-gradient(135deg,#059669,#8B5CF6)", trackClass: "track-a", trackName: "Creatividad e Identidad", talkIcon: "🎸", talkName: "Ser Humano en escena" },
  { img: "", initials: "GS", name: "Gurudev Sri Sri Ravi Shankar", company: "El Arte de Vivir", role: "Líder Humanitario", bio: "Líder humanitario y maestro espiritual, fundador de la organización internacional El Arte de Vivir.", gradient: "linear-gradient(135deg,#E91E8C,#F0922A)", trackClass: "track-a", trackName: "Espiritualidad", talkIcon: "🧘‍♂️", talkName: "Sabiduría Eterna" },
