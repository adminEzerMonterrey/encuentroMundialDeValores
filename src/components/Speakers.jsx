...
// Data Array to keep JSX cleanconst speakersData = [
  ...
  { img: "/Speakers/Abuelo_Maya_Antonio_Oxté.jpg", imgPosition: "top", imgScale: "1.8", imgOffsetY: "-20px", initials: "AO", name: "Abuelo Maya Antonio Oxté", company: "Medicina Tradicional", role: "Sabio Maya", bio: "Médico tradicional y maestro espiritual de Yucatán. Puente vivo entre el profundo conocimiento ancestral y el mundo actual.", gradient: "linear-gradient(135deg,#a3335f,#8B5CF6)", trackClass: "track-a", trackName: "Espiritualidad", talkIcon: "🌿", talkName: "Sabiduría Ancestral" },
