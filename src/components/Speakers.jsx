...
const speakersData = [
  ...
  { img: "/Speakers/Caroline_Sanchez_Crozier.jpeg", imgPosition: "top center", imgScale: "0.95", initials: "CC", name: "Caroline Sanchez Crozier", company: "CSC Consulting Group", role: "CEO & Fundadora", bio: "Líder tecnológico y presidenta del Comité de Tecnología e IA de LULAC. Inmigrante mexicana y pionera en equidad digital.", gradient: "linear-gradient(135deg,#E91E8C,#9333ea)", trackClass: "track-a", trackName: "Educación", talkIcon: "🤝", talkName: "Tecnología y Educación" },
  ...
  { img: "/Speakers/Padre_David_Jasso.png", imgPosition: "top", imgScale: "1.3", imgOffsetY: "-15px", initials: "DJ", name: "Padre David Jasso", company: "Arquidiócesis de Monterrey", role: "Sacerdote", bio: "Sacerdote, comunicólogo y ex directivo del Club Rayados. Promotor del talento humano y la pastoral social latinoamericana.", gradient: "linear-gradient(135deg,#FF9900,#e65c00)", trackClass: "track-a", trackName: "Espiritualidad", talkIcon: "🕊️", talkName: "Conexión y Fe" },
