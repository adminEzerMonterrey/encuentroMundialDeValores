...
const faqData = [
  ...
  { q: '¿Quién puede asistir?', a: 'Principalmente estudiantes de EMV de UDEM, TEC de Monterrey y UANL. También hay espacio para invitados de otras instituciones.' },
      ...
      <section className="section faqs" id="faqs" aria-labelledby="faqsHeading">
        <div className="container container--narrow">
          ...
          <div className="faqs-cta reveal-up">
            ...
            <a href="https://www.instagram.com/encuentromundialdevalores?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noopener noreferrer" className="btn btn--primary btn--starry" style={{display:'inline-flex', alignItems:'center', justifyContent:'center', textAlign:'center', minWidth: 200}}>
              Escríbenos →
